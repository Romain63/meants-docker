...
/**
 * Represents the admin sensor create guard.
 * @class
 */
@Injectable()
export class SensorCreateGuard extends BaseRigthsGuard {
  /**
   * Initialize the SensorCreateGuard class.
   * @constructor
  ...
  constructor(
    ...
    super(authorizationGuardService, storageService, router, 'R_API_SENSOR_C');
  }
}
