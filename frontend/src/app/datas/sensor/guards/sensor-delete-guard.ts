...
/**
 * Represents the admin sensor delete guard.
 * @class
 */
@Injectable()
export class SensorDeleteGuard extends BaseRigthsGuard {
  /**
   * Initialize the SensorDeleteGuard class.
   * @constructor
  ...
  constructor(
    ...
    super(authorizationGuardService, storageService, router, 'R_API_SENSOR_D');
  }
}
