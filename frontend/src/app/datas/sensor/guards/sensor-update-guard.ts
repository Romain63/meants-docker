...
/**
 * Represents the admin sensors update guard.
 * @class
 */
@Injectable()
export class SensorUpdateGuard extends BaseRigthsGuard {
  /**
   * Initialize the SensorUpdateGuard class.
   * @constructor
  ...
  constructor(
    ...
    super(authorizationGuardService, storageService, router, 'R_API_SENSOR_U');
  }
}
